...
class ModbusCoordinator(DataUpdateCoordinator):    
    def __init__(self, hass, device, device_model:str, connection_params, scan_interval, scan_interval_fast, rtu_bus, tcp_bus=None):
    ...
    async def _async_setup(self):
        ...
        if device_class is not None:
            try:
                self._modbusDevice = device_class(self.connection_params, self.rtu_bus, self.tcp_bus)
