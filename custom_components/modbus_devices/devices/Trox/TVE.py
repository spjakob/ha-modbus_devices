...
class Device(ModbusDevice):
    ...
    def loadDatapoints(self):
        ...
        self.Datapoints[GROUP_0] = {
            "Setpoint Flowrate": ModbusDatapoint(
                address=0,
                scaling=0.01,
                entity_data=EntityDataNumber(
                    units=PERCENTAGE, min_value=0, max_value=100, step=1
                ),
            ),
            "Override": ModbusDatapoint(
                address=1,
                entity_data=EntityDataSelect(
                    options={0: "None", 1: "Open", 2: "Closed", 3: "Q Min", 4: "Q Max"}
                ),
            ),
            "Command": ModbusDatapoint(
                address=2,
                entity_data=EntityDataSelect(
                    options={0: "None", 1: "Synchronization", 2: "Test", 4: "Reset"}
                ),
            ),
            "Position": ModbusDatapoint(
                address=4,
                scaling=0.01,
            ...
            "Position Degrees": ModbusDatapoint(
                address=5,
                entity_data=EntityDataSensor(
                    stateClass=SensorStateClass.MEASUREMENT, units=DEGREE
                ),
            ),
            "Flowrate Percent": ModbusDatapoint(
                address=6,
                scaling=0.01,
                entity_data=EntityDataSensor(
                    stateClass=SensorStateClass.MEASUREMENT, units=PERCENTAGE
            ...
            "Flowrate Actual": ModbusDatapoint(
                address=7,
                entity_data=EntityDataSensor(
            ...
            "Analog Setpoint": ModbusDatapoint(
                address=8,
                scaling=0.001,
                entity_data=EntityDataSensor(
                    stateClass=SensorStateClass.MEASUREMENT,
        ...
        self.Datapoints[ModbusDefaultGroups.CONFIG] = {
            "105 Q Min Percent": ModbusDatapoint(
                address=105,
                scaling=0.01,
                entity_data=EntityDataNumber(
                    units=PERCENTAGE, min_value=0, max_value=100, step=1
            ...
            "106 Q Max Percent": ModbusDatapoint(
                address=106,
                scaling=0.01,
                entity_data=EntityDataNumber(
                    units=PERCENTAGE, min_value=0, max_value=100, step=1
            ...
            "109 Bus Timeout": ModbusDatapoint(
                address=109,
                entity_data=EntityDataNumber(
                    units=UnitOfTime.SECONDS, min_value=0, max_value=100, step=1
                ),
            ),
            "120 Q Min": ModbusDatapoint(
                address=120,
                entity_data=EntityDataNumber(
                    deviceClass=NumberDeviceClass.VOLUME_FLOW_RATE,
                    units=UnitOfVolumeFlowRate.CUBIC_METERS_PER_HOUR,
                    icon="mdi:weather-windy",
                ),
            ),
            "121 Q Max": ModbusDatapoint(
                address=121,
                entity_data=EntityDataNumber(
                    deviceClass=NumberDeviceClass.VOLUME_FLOW_RATE,
                    units=UnitOfVolumeFlowRate.CUBIC_METERS_PER_HOUR,
            ...
            "569 Modbus Response Delay": ModbusDatapoint(
                address=569,
                entity_data=EntityDataNumber(
                    units=UnitOfTime.MILLISECONDS, min_value=0, max_value=255, step=1
                ),
            ),
